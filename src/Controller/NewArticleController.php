...
use App\Form\ArticlemotivatorType;
...
class NewArticleController extends AbstractController
{
    ...
    // here for the admin to post an article with money price to sell
    ...
    // here for the motivator to post an article without selling it
    #[Route('/new/motivator_article', name: 'app_motivatorarticle')]
    public function notselling(Request $request,SluggerInterface $slugger,Security $security,ManagerRegistry $save,EntityManagerInterface $entityManagerInterface): Response
    {
        ...
        return $this->render('new_article/motivatorsell.html.twig', [
            'newform' => $form,
            'users'=>$userforuser,
            'demandes'=>$demandes,
            'validedemandes'=>$validedemandes,
